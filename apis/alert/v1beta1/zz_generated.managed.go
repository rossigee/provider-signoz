...
// GetExternalName returns the external name of this Alert.
func (mg *Alert) GetExternalName() string {
	return meta.GetExternalName(mg)
}

// SetExternalName sets the external name of this Alert.
func (mg *Alert) SetExternalName(name string) {
