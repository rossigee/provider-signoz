...
// GetExternalName returns the external name of this Dashboard.
func (mg *Dashboard) GetExternalName() string {
	return meta.GetExternalName(mg)
}

// SetExternalName sets the external name of this Dashboard.
func (mg *Dashboard) SetExternalName(name string) {
